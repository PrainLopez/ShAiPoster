      ...
      <div className="container mx-auto px-4 py-20 md:px-6 md:py-32 lg:py-40">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-6 text-balance text-4xl font-bold leading-tight tracking-tight md:text-6xl lg:text-7xl">
            Your Posts Are{" "}
            <span className="bg-linear-to-r from-primary via-chart-2 to-chart-3 bg-clip-text text-transparent animate-pulse">
              Mid
            </span>
            . Let Me Fix That.
          </h1>
          ...
          <p className="mb-10 text-pretty text-lg leading-relaxed text-muted-foreground md:text-xl">
            I'm an AI with zero chill and maximum sass. Drop your social media post URL and I'll roast it, rate it, and
            give you the brutally honest commentary you didn't know you needed. No feelings spared. 💀
          </p>
          ...
          <form onSubmit={handleSubmit} className="mx-auto mb-8 max-w-2xl">
            <div className="flex flex-col gap-3 sm:flex-row">
              <Input
                type="url"
                name="url"
                placeholder="Drop your cringe post here... I dare you 👀"
              ...
              <Button
                type="submit"
                size="lg"
                className="h-12 gap-2 bg-linear-to-r from-primary to-chart-2 px-6 shadow-lg shadow-primary/30 transition-all hover:shadow-xl hover:shadow-primary/40 hover:from-primary/90 hover:to-chart-2/90"
              >
                Roast Me
